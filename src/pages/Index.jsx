    ...
    <div className="min-h-screen flex flex-col">
      <div className="bg-aadhaar-primary text-white py-16">
        <div className="container mx-auto text-center px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fade-in">Aadhaar Registration & Family Tree</h1>
          ...
          <div className="flex flex-wrap justify-center gap-4 animate-fade-in" style={{animationDelay: "0.4s"}}>
            <Link to="/register">
              <Button className="bg-gradient-to-r from-purple-600 to-indigo-700 hover:from-purple-700 hover:to-indigo-800 text-white font-medium px-6 py-2 rounded-full shadow-md transition-all duration-300 transform hover:scale-105">
                Get Started
              </Button>
            </Link>
            <Link to="/family-tree">
              <Button className="bg-white text-indigo-700 hover:bg-gray-100 font-medium px-6 py-2 rounded-full shadow-md border border-indigo-200 transition-all duration-300 transform hover:scale-105">
                View Family Tree
              </Button>
            </Link>
          </div>
      ...
      <div className="container mx-auto py-16 px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="card text-center p-8 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
